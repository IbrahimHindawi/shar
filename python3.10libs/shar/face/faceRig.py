...
def BuildCurves():
    ...
    for pointgroup in pointgroups:
        ...
        parmfolder = hou.FolderParmTemplate("folder", "Blends")
        ...
        blendshapes.parm("blend2").setExpression('ch("../'+pointgroup.name() + "_down"+'")')
        blendshapes.parm("blend3").setExpression('ch("../'+pointgroup.name() + "_in"+'")')
        blendshapes.parm("blend4").setExpression('ch("../'+pointgroup.name() + "_out"+'")')
